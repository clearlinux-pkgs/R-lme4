...
Version  : 1.1.31
Release  : 107
URL      : https://cran.r-project.org/src/contrib/lme4_1.1-31.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lme4_1.1-31.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667333431
