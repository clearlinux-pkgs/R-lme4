...
Version  : 1.1.36
Release  : 124
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/lme4_1.1-36.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/lme4_1.1-36.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738190596
...
/usr/lib64/R/library/lme4/tests/testthat/test-summary_testlevel_1.rda
